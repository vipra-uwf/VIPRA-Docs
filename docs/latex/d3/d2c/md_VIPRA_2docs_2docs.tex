\chapter{docs}
\hypertarget{md_VIPRA_2docs_2docs}{}\label{md_VIPRA_2docs_2docs}\index{docs@{docs}}
\texorpdfstring{$\vert$}{|} \doxysectlink{md_VIPRA_2docs_2pages_2researchers_2usage}{How To Use}{0} \texorpdfstring{$\vert$}{|} \doxysectlink{md_VIPRA_2docs_2pages_2developers_2overview}{Developing Modules}{0} \texorpdfstring{$\vert$}{|} \doxysectlink{md_VIPRA_2docs_2pages_2developers_2library}{Using as a Library}{0} \texorpdfstring{$\vert$}{|} \texorpdfstring{$\vert$}{|} --- \texorpdfstring{$\vert$}{|} --- \texorpdfstring{$\vert$}{|} --- \texorpdfstring{$\vert$}{|}\hypertarget{md_VIPRA_2docs_2docs_autotoc_md386}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{md_VIPRA_2docs_2docs_autotoc_md386}
...
\item as a \doxysectlink{md_VIPRA_2docs_2pages_2researchers_2usage}{Standalone Simulation}{0}
\end{DoxyItemize}\hypertarget{md_VIPRA_2docs_2docs_autotoc_md387}{}\doxysection{\texorpdfstring{Researchers}{Researchers}}\label{md_VIPRA_2docs_2docs_autotoc_md387}
For those that intend to\+:
\begin{DoxyItemize}
\item use premade models / modules for running simulations
\end{DoxyItemize}
\begin{DoxyEnumerate}
\item \doxysectlink{md_VIPRA_2docs_2pages_2researchers_2usage}{How to use VIPRA}{0}
\end{DoxyEnumerate}

\DoxyHorRuler{0}
\hypertarget{md_VIPRA_2docs_2docs_autotoc_md389}{}\doxysection{\texorpdfstring{Developers}{Developers}}\label{md_VIPRA_2docs_2docs_autotoc_md389}
For those that intend to\+:
\begin{DoxyItemize}
\item develop new models / module implementations
\item Use VIPRA in their projects
\end{DoxyItemize}
\begin{DoxyEnumerate}
\item \doxysectlink{md_VIPRA_2docs_2pages_2developers_2setup}{Developer Setup}{0}
\end{DoxyEnumerate}

\DoxyHorRuler{0}
\hypertarget{md_VIPRA_2docs_2docs_autotoc_md391}{}\doxysection{\texorpdfstring{VIPRA Oct 2024 Workshop}{VIPRA Oct 2024 Workshop}}\label{md_VIPRA_2docs_2docs_autotoc_md391}
\href{https://vipra-uwf.github.io/VIPRA/workshop.html}{\texttt{ Check out our Oct 2024 Workshop}}
