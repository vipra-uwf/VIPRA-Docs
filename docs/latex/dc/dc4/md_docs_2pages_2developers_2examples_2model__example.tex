...
\hypertarget{md_docs_2pages_2developers_2examples_2model__example}{}\label{md_docs_2pages_2developers_2examples_2model__example}\index{Model Implementation Example@{Model Implementation Example}}
\label{md_docs_2pages_2developers_2examples_2model__example_autotoc_md8}%
\Hypertarget{md_docs_2pages_2developers_2examples_2model__example_autotoc_md8}%


In this example we will walk through creating a \doxysectlink{md_docs_2pages_2developers_2implementation_2model}{{\ttfamily Model}}{0} module. This Model will simply have pedestrians walking in circles around their initial position.
...
See the \doxysectlink{md_docs_2pages_2developers_2implementation_2module}{Base Module Implementation}{0} to see more.
...
\end{DoxyCode}
\hypertarget{md_docs_2pages_2developers_2examples_2model__example_autotoc_md9}{}\doxysection{\texorpdfstring{The output will be under {\ttfamily ./output/trajectories.json}}{The output will be under {\ttfamily ./output/trajectories.json}}}\label{md_docs_2pages_2developers_2examples_2model__example_autotoc_md9}
